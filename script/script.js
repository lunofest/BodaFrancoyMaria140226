...
function updateTimer() {
    const targetDate = new Date("february 14, 2026 18:45:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const recipientNumber1 = '542644105969'; // Número para el primer botón
  const recipientNumber2 = '542645815781'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
    // Definir los números de teléfono
    const phoneNumber1 = '542644105969'; // Número para el primer botón
